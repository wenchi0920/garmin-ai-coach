...
3. **[賽事英文].md (詳情)**：**重要： 檔名範例 **Honolulu_Marathon.md** , 請引用當年度最新的資料**在末尾新增四段式結構：### [中文名] ([英文名])。包含「1. 歷史背景」、「2. 賽道技術分析」(含配速策略)、「3. 補給特色」、「4. 教練專業評論」(含 PB 潛力、LSD 定位), 要建立 **[返回國家索引](README.md) | [返回全球總索引](../README.md)**。
